...
object DefaultKeyboardShortcuts {
    val bindings: Map<BrowserCommandId, KeyChord> = mapOf(
        ...
        BrowserCommandId.TRANSLATE_PAGE to KeyChord(KeyEvent.KEYCODE_Y, ctrl = true, shift = true),
...
object BrowserCommands {
    val all = listOf(
        ...
        BrowserCommand(BrowserCommandId.TRANSLATE_PAGE, "Translate page", "Translate the active page"),
