...
- Mouse secondary-click context menus and keyboard shortcuts.
...
Current automated tests cover URL handling, navigation policy, Firefox Add-on URL parsing, and the native download request path. The project still needs physical-device and instrumentation coverage for:
